...
public class RockPaperScissors {
	...
	//	Print out who won.
		...
		//verify input
		if (verifyInput(userInput) != "ERROR") {
				// You have good stuff proceed
			...
			if (winner == 0 ) {
				// error duplicate show tie and soliciate input again
				System.out.println("");
			...
			System.out.println("Your guess of " + userInput + " is not valid, please try again.");
			playGame();
		};
